  ...
  function e(e, a, n) {
    ...
    return (
      t.each(o, function (t, e) {
        ("srcset" !== e.name && e.name !== i) || (e.value = r(e.value, n)),
          c.attr(e.name, e.value);
      }),
      e.replaceWith(c),
      c
    );
      ...
      c.length
        ? (c.each(function () {
          ...
          1 === s.length
            ? ((s = e(s, "img", u)),
              ...
              s.attr("src", s.attr(i)),
              this.config("removeAttribute") && s.removeAttr(i))
            : n.attr(i)
            ? (a(n, u + n.attr(i), o),
        ...
        ? (t("<source>")
          ...
          this.config("removeAttribute") &&
            n.removeAttr(i + " data-srcset data-media data-sizes data-type"))
        : o(!1);
    } else o(!1);
  });
